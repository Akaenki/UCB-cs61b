...
/* We do not need to import iterable but need to import java.util.Iterator */
...
/** Inorder to use the enhance for loop we need to make the class iterable by
...
public class ArrayMap<K, V> implements Map61B<K, V>, Iterable<K> {
    ...
    /** This public method allows the KeyIterator class to be private
     *  and can still be instantiate by other class
     */
