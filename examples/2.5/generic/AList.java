...
public class AList<Item> implements List61B<Item>{
    ...
    public AList() {
    	size = 0;
    	/* Java does not allow generic array\
    	 * Create an Object array and cast it to generic type Item
    	 * The will cause compiler warnings which can be ignored
    	 */
    ...
    public Item removeLast() {
		...
		/* Must set the roemoved item to null if using generic type */
		items[size - 1] = null;
		size = size - 1;
		return itemToReturn;
    }
